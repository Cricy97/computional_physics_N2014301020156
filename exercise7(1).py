...
figure(figsize=(8,6))
scatter(theta_array1,omega1_array1,label="Force=0",color="green",linewidth=0.01,linestyle='-')
scatter(theta_array2,omega2_array2,label="Force=0.5",color="red",linewidth=0.01,linestyle='-')
scatter(theta_array3,omega3_array3,label="Force=1.2",color="purple",linewidth=0.01,linestyle='-')
