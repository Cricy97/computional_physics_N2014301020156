...
d = reduced_air_density_drag_cannon(flight_state(0, 0, 700*cos(pi*35/180), 700*sin(pi*35/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
...
d = reduced_air_density_drag_cannon(flight_state(0, 0, 700*cos(pi*40/180), 700*sin(pi*40/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
...
d = reduced_air_density_drag_cannon(flight_state(0, 0, 700*cos(pi*42.5/180), 700*sin(pi*42.5/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
...
d = reduced_air_density_drag_cannon(flight_state(0, 0, 700*cos(pi*45/180), 700*sin(pi*45/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
...
d = reduced_air_density_drag_cannon(flight_state(0, 0, 700*cos(pi*50/180), 700*sin(pi*50/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
...
d = reduced_air_density_drag_cannon(flight_state(0, 0, 700*cos(pi*55/180), 700*sin(pi*55/180), 0), _dt = 0.1)
d.shoot()
d.show_trajectory()
